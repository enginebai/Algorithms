...
## Greedy (Single Pass, Track Previous)
Alternatively, you can keep a pointer to the last kept balloon and always remove the one with the smaller `neededTime` when a duplicate is found.
