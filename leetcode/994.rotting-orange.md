...
* If there is no fresh orange, the time should be 0 whether there are rotton oranges or not.
...
Please note that the way how to enqueue affects the way to check the rotton oranges and increment the minutes.
...
We can start from the initial rotton oranges and **enqueue the fresh oranges nearby** to be rotten.
