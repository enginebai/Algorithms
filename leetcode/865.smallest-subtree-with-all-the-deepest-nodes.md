...
> Same as [1123. Lowest Common Ancestor of Deepest Leaves](https://leetcode.com/problems/lowest-common-ancestor-of-deepest-leaves/)

**Key Insight:**
最深的葉子可能只有一個，那麼它就是答案。如果最深的葉子有多個，那麼答案就是所有最深葉子的 LCA。
...
- If the left subtree is deeper, then the LCA of the deepest nodes is in the left subtree. If the right subtree is deeper, then the LCA of the deepest nodes is in the right subtree.
```js
// Answer = L
        root
       /    \
