...
## WA
Splitting into equal halves is not optimal, for example, `9 -> [4, 5] -> [2, 2, 5] -> [2, 2, 2, 3]` which needs 3 operations. But `9 -> [6, 3] -> [3, 3, 3]` which needs 2 operations that is optimal.
...
private fun checkWA(nums: IntArray, maxOperations: Long, max: Long): Boolean {
    ...
    9 = [8,1] / [7,2] / [6,3] / [5,4], num / 2 leads optimal split
    */ 
